...
- P3 self-hosted offline software blockers: the Tasks 1-6 package is in progress. Server bootstrap passed through Gate 6.3; Gate 6.4 needs read-only reconciliation, Gate 6.5C rolled back, the protected profile is absent, and all live Windows gates remain separately authorized and open.
