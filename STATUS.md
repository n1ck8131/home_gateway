...
- Local evidence: full repository verification, focused Go/Pester/shell checks, pinned ShellCheck, root and non-root isolated APK lifecycle checks, two clean byte-identical OpenWrt SDK outputs and independent QA/security audits passed
...
- P3.4/P3.5-preparation hosted evidence for commit `9c5903c3ff1d474a3112a20d784d9ab128afad1a`: [CI run 32728418853](https://github.com/n1ck8131/home_gateway/actions/runs/32728418853) passed Windows/Linux verification, Linux race tests and the network namespace gate; [OpenWrt QEMU run 32728418833](https://github.com/n1ck8131/home_gateway/actions/runs/32728418833) passed the rollback/LKG regression; [OpenWrt SDK run 32728418835](https://github.com/n1ck8131/home_gateway/actions/runs/32728418835) exercised the non-root APK lifecycle, reproduced both clean output trees byte-for-byte, passed ShellCheck and uploaded `verified-openwrt-outputs` artifact ID `9521547381`
