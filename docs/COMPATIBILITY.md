...
The P3.4 hosted run uploaded `verified-openwrt-outputs` artifact ID
`9521547381`, 3,904,982 bytes, archive digest
`sha256:00af33a62a4ca294f9af3e093938915517e50508363649b58331b583d0f33a8a`.
Its GitHub retention expires on 2026-08-31; the per-file hashes above remain
the durable evidence after expiry.
