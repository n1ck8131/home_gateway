...
4. Removing the profile from the app is limited client-side rollback. **Clear server from Amnezia software** is a separate broad/destructive server action and always needs fresh approval.
